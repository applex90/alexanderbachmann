...
export class PortfolioSectionComponent implements OnInit {
  projects = [
    ...
    { title: 'Slackclone', description: 'A Slack chat app clone built with Angular and Firebase. The project was created together with other programmers.', imgsrc: 'assets/img/ringoffire.jpg', alt: 'Slackclone', url: 'https://slackwebclone.web.app/' }
  ];
